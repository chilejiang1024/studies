package main.lawyer.cert;

/**
 * Title : main.lawyer.cert
...
public class GenerateCert {
    ...
    public void createIssueCert(X500Name issue, X500Name subject, String issueAlias, String issuePfxPath,
            ...
            throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, CertificateException, IOException, KeyStoreException, UnrecoverableKeyException, SignatureException {
    ...
    public void createRootCert(String issuePfxPath, String issueCrtPath, X500Name issue)
            throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, IOException, CertificateException, SignatureException, KeyStoreException {
     ...
     * @throws IOException
     */
    public String readPrivateKeyStr(String alias, String pfxPath, String password)
    ...
    public String getPriExponentByPfx(String alias, String pfxPath, String password) {
        ...
        String modulus = pfx
                .substring(pfx.indexOf("privateexponent:") + "privateexponent:".length(), pfx.indexOf("primep:"));
    ...
    public String getdpByPfx(String alias, String pfxPath, String password) {
        ...
        String modulus = pfx
                .substring(pfx.indexOf("primeexponentp:") + "primeexponentp:".length(), pfx.indexOf("primeexponentq:"));
    ...
    public String getdqByPfx(String alias, String pfxPath, String password) {
        ...
        String modulus = pfx
                .substring(pfx.indexOf("primeexponentq:") + "primeexponentq:".length(), pfx.indexOf("crtcoefficient:"));
    ...
    public static void main(String args[]) throws IOException {
        ...
        GenerateCert test = new GenerateCert();
